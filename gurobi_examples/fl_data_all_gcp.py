...
client_prov_regions_vms, time_exec = gp.multidict({
    (0, 'AWS', 'us-east-1', 'g4dn.2xlarge'): 280,
    (1, 'AWS', 'us-east-1', 'g4dn.2xlarge'): 224,
    (2, 'AWS', 'us-east-1', 'g4dn.2xlarge'): 286,
    (3, 'AWS', 'us-east-1', 'g4dn.2xlarge'): 224,
    (0, 'GCP', 'us-central1', 'n1-standard-8'): 187,
    (1, 'GCP', 'us-central1', 'n1-standard-8'): 180,
    (2, 'GCP', 'us-central1', 'n1-standard-8'): 188,
    (3, 'GCP', 'us-central1', 'n1-standard-8'): 187,
})
