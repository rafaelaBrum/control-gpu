...
CREATE ROLE gera1;
ALTER ROLE gera1 WITH NOSUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'rafaela123';
CREATE ROLE postgres;
ALTER ROLE postgres WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'rafaela123';
...
--
-- Name: controlgpudb; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE controlgpudb WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.utf8' LC_CTYPE = 'en_US.utf8';


ALTER DATABASE controlgpudb OWNER TO postgres;

\connect controlgpudb
