...
class DaemonCloudLab:
    ...
    def handle_command(self, action, value):
        ...
        if action == DaemonCloudLab.START:
        ...
        elif action == DaemonCloudLab.STOP:
        ...
        # elif action == DaemonCloudLab.INSTANCE_USAGE:
        #     try:
        #
        ...
        elif action == DaemonCloudLab.TEST:
