...
from shakespeare_app.stacked_lstm import ClientModel

ACCURACY_KEY = 'accuracy'

MODEL_PARAMS = (0.0003, 80, 80, 256)  # lr, seq_len, num_classes, num_hidden
...
def get_args():
    ...
    arg_groups = []
    parser = argparse.ArgumentParser(description='Flower client of LEAF with Shakespeare dataset')
...
# Flower client
class StackedLSTMClient(fl.client.NumPyClient):
...
if __name__ == "__main__":
    ...
    client = StackedLSTMClient(client_id=user, train_data=train_data, eval_data=test_data,
